"""
gen_low_re_flowfield_figs.py

Same vorticity evolution montage as gen_flowfield_figs_v2.py (SD7003/
SD8000, now in high_re/): 7 snapshots (t=0..30), py/ibpm.py row + C++
build/ibpm row, applied to the low_re/ airfoils (ClarkY, GM15).

Usage: python3 SURF_test/gen_low_re_flowfield_figs.py
Output: SURF_test/low_re/{ClarkY,GM15}/1-orig/flow_evolution.png
"""
...
CASES = {
    "ClarkY": dict(alpha=4.16, Re=60700, dat=REPO / "SURF_test" / "low_re" / "ClarkY" / "clarky.dat.txt"),
    "GM15": dict(alpha=4.61, Re=40600, dat=REPO / "SURF_test" / "low_re" / "GM15" / "gm15.dat.txt"),
}
...
for name, cfg in CASES.items():
    outdir = REPO / "SURF_test" / "low_re" / name / "1-orig"
    outdir.mkdir(parents=True, exist_ok=True)
    py_rundir = REPO / "SURF_test" / "low_re" / name / "_run_data" / "flowfield"
    cpp_rundir = REPO / "SURF_test" / "low_re" / name / "_run_data_cpp" / "flowfield"
