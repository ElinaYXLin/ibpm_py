"""
gen_clarky_gm15_report.py

Same result-presentation code/style as gen_airfoil_report_v2.py (SD7003/
SD8000, now in airfoils/): THREE series -- py/ibpm.py, this repo's C++
...
Applied here to the two airfoils/ airfoils instead: ClarkY (Re=60700 --
...
See SURF_test/airfoils/README.md for why these two.

Usage:
    python3 SURF_test/gen_clarky_gm15_report.py

Output (per case):
    SURF_test/airfoils/{ClarkY,GM15}/1-orig/polar_comparison.png
    SURF_test/airfoils/{ClarkY,GM15}/1-orig/drag_polar.png
    SURF_test/airfoils/{ClarkY,GM15}/1-orig/grid_convergence.png
    SURF_test/airfoils/{ClarkY,GM15}/1-orig/summary.txt
"""
...
py_results = json.loads((SURF / "batch_results_clarky_gm15.json").read_text())
cpp_results = json.loads((SURF / "batch_results_clarky_gm15_cpp.json").read_text())
