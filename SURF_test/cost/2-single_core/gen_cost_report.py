# gen_cost_report.py
#
# Reads SURF_test/cost/raw/cost_results.json (produced by run_benchmark.py)
...
# `python3 SURF_test/cost/run_ibpm_case.py` run, measured with
...
# SURF_test/built_in_tests/generate_validation_report.py's runtime_phase_breakdown.png
# ======================================================================
