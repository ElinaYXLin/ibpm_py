"""
gen_clarky_gm15_flowfield_figs.py

Same vorticity evolution montage as gen_flowfield_figs_v2.py (SD7003/
SD8000, now in airfoils/): 7 snapshots (t=0..30), py/ibpm.py row + C++
build/ibpm row, applied to the airfoils/ airfoils (ClarkY, GM15).

Usage: python3 SURF_test/gen_clarky_gm15_flowfield_figs.py
Output: SURF_test/airfoils/{ClarkY,GM15}/1-orig/flow_evolution.png
"""
