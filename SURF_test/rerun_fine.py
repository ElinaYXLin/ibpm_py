...
CASES = {
    "SD7003": dict(dat=REPO / "SURF_test" / "SD7003" / "sd7003.dat.txt", Re=61100, conv_alpha=-0.09),
    "SD8000": dict(dat=REPO / "SURF_test" / "SD8000" / "sd8000.dat.txt", Re=60800, conv_alpha=-0.81),
}
