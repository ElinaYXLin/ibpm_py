...
CASES = {
    "SD7003": dict(dat=REPO / "SURF_test" / "airfoils" / "LSAT-SD7003" / "sd7003.dat.txt", Re=61100, conv_alpha=-0.09),
    "SD8000": dict(dat=REPO / "SURF_test" / "airfoils" / "LSAT-SD8000" / "sd8000.dat.txt", Re=60800, conv_alpha=-0.81),
}
...
for name, cfg in CASES.items():
    ...
    outdir = REPO / "SURF_test" / "airfoils" / f"LSAT-{name}" / "_run_data" / "conv_fine_dt0005"
