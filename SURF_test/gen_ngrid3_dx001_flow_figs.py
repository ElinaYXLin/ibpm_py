...
ALPHA = 4.60
DAT = SURF / "SD7003" / "sd7003.dat.txt"
VMAX = 8.0
...
def main():
    ...
    make_flow_evolution(
        outdir=SURF / "SD7003" / "3-ngrid=3",
        py_dir=SURF / "SD7003" / "_run_data_ngrid3" / "flowfield",
        cpp_dir=SURF / "SD7003" / "_run_data_ngrid3_cpp" / "flowfield",
    ...
    make_flow_evolution(
        outdir=SURF / "SD7003" / "3-dx0.01",
        py_dir=SURF / "SD7003" / "_run_data_dx001" / "flowfield",
        cpp_dir=SURF / "SD7003" / "_run_data_dx001_cpp" / "flowfield",
        dt=0.005, steps=[0, 1000, 2000, 3000, 4000, 5000, 6000],
