...
Output: SURF_test/SD7003/3-ngrid=3/instability_diagnostic.png
"""
import pathlib
import sys
import types
...
def main():
    ...
    base_dir = SURF / "SD7003" / "_run_data" / "flowfield"
    ...
    ng3_dir = SURF / "SD7003" / "_run_data_ngrid3" / "flowfield"
    ...
    dx02 = load(SURF / "SD7003" / "_run_data" / "flowfield" / "flow03000.bin")
    dx01 = load(SURF / "SD7003" / "_run_data_dx001" / "flowfield" / "flow06000.bin")
    dxs = [0.02, 0.01]
    ...
    outpath = SURF / "SD7003" / "3-ngrid=3" / "instability_diagnostic.png"
