...
Conservation / physical sanity (not expected to be ~0, just smooth/bounded):
  ...
  8. Cd, Cl        -- reproduced independently here; cross-checked against
                      the archived SURF_test/vortall/1-baseline/_run_data/vortall.force
...
# Same grid/physics as SURF_test/vortall/1-baseline/run_vortall.py (pinned by
# VORTALL.mat's own 449x199 shape -- see SURF_test/vortall/1-baseline/README.md).
...
def main() -> None:
    ...
    ap.add_argument("--nsteps", type=int, default=3000,
                      help="number of timesteps to run (default 3000, t=60: "
                           ...
                           "growth region identified in SURF_test/vortall/1-baseline/README.md)")
