"""Flowfield case for low_re/ClarkY and low_re/GM15 (Python), same
methodology/parameters as run_flowfield.py (SD7003/SD8000, now in
high_re/): dx=0.02, dt=0.01, nsteps=3000 (t=30), restart every 250 steps
(7 snapshots at t=0,5,...,30).

Usage:  python3 SURF_test/run_low_re_flowfield.py
Output: SURF_test/low_re/{ClarkY,GM15}/_run_data/flowfield/
"""
import sys, pathlib
...
for name, cfg in CASES.items():
    outdir = REPO / "SURF_test" / "low_re" / name / "_run_data" / "flowfield"
