...
`airfoils/SD7003/2-c++included/` shows, but there's no earlier
...
fine grid and for the `ngrid=3` investigation in `airfoils/SD7003/3-ngrid=3/`.
...
mechanism `airfoils/SD7003/README.md` documents for its own dx=0.01 case,
