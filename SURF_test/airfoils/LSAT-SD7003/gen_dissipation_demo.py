...
Usage: python3 SURF_test/airfoils/LSAT-SD7003/gen_dissipation_demo.py
Output: SURF_test/airfoils/LSAT-SD7003/6-explicit_dissipation/filter_demo.png
"""
import pathlib
import sys
import types
...
SRC = REPO / "SURF_test" / "airfoils" / "LSAT-SD7003" / "4-Re_sweep" / "_run_data_cpp" / "Re40000" / "run03000.bin"
OUTDIR = REPO / "SURF_test" / "airfoils" / "LSAT-SD7003" / "6-explicit_dissipation"
...
def main():
    ...
    pts = load_dat_pts(REPO / "SURF_test" / "airfoils" / "LSAT-SD7003" / "sd7003.dat.txt")
