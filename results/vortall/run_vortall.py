...
#
# Usage: python3 results/vortall/run_vortall.py
...
OUTDIR_CPP = REPO / "results" / "vortall" / "_run_data_cpp"
OUTDIR_PY = REPO / "results" / "vortall" / "_run_data"
...
def main() -> None:
    ...
    run_ibpm_runner = REPO / "results" / "cost" / "run_ibpm_case.py"
